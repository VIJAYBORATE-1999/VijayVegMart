                ...
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        ...
                        <div class=" offset-1 col-lg-9">
                            <form action="" class="">
                                <input type="text" class="w-60 form-control border-0 py-3 mb-4" placeholder="Enter Your Email">
                                <input type="email" class="w-60 form-control border-0 py-3 mb-4" placeholder="Enter Your Password">
